...
ARG shadowsocks_rust_latest_commit_hash=bc063c3f471f1e75df230aaf5cd0c9e84a4b7a2a
...
ARG b3sum_latest_tag_name=1.5.1
WORKDIR /usr/local/cargo/bin
RUN source '/root/.bashrc' \
...
ARG ripgrep_latest_commit_hash=3ad0e83471588d8802d5747d0cc9accec76f7ccf
WORKDIR /git/ripgrep
RUN source '/root/.bashrc' \
...
ARG sd_latest_commit_hash=2d287b9b1c21d6ca21e649f9d97e0b5e9e542e12
WORKDIR /usr/local/cargo/bin
RUN source '/root/.bashrc' \
