...
ARG shadowsocks_rust_latest_commit_hash=00c16af86445392f872c5e43c5c91eb0c9ae86b3
...
ARG rsign2_latest_commit_hash=64f385be8c1fcb8f7a03dbb10db702e6c4d5751f
WORKDIR /usr/local/cargo/bin
RUN source '/root/.bashrc' \
...
ARG b3sum_latest_tag_name=1.6.1
WORKDIR /usr/local/cargo/bin
RUN source '/root/.bashrc' \
...
ARG ripgrep_latest_commit_hash=de4baa10024f2cb62d438596274b9b710e01c59b
WORKDIR /git/ripgrep
RUN source '/root/.bashrc' \
